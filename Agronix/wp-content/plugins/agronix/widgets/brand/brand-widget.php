    ...
    protected function render() {
        ...
        <?php if ( $settings['design_style'] === 'style_3' ): ?>
            ...
            <div class="tp-supporter__area">
                <div class="container">
                   <span class="tp-supporter-sub-title tp-supporter-sub-title-ab mb-25"><?php echo bdevs_element_kses_intermediate($settings['title']); ?></span>
        ...
        <div class="tp-supporter__area">
            <span class="tp-supporter-sub-title mb-25"><?php echo bdevs_element_kses_intermediate($settings['title']); ?></span>
            <div class="container">
                  <div class="row no-gutters">
                     <div class="col-xl-12">
                        <div class="tp-supporter__slider tp-supporter__slider-tpages tp-supporter__slider-active owl-carousel text-center">
                               <?php 
                                    foreach ( $settings['slides'] as $slide ) :
                                    $image = wp_get_attachment_image_url( $slide['image']['id'], $settings['thumbnail_size'] );
                                    if ( ! $image ) {
                              ...
                              <div class="tp-supporter__thumb">
                                  <a href="<?php echo esc_url( $slide['slide_url'] ); ?>"><img src="<?php print esc_url($image); ?>" alt="<?php echo get_post_meta(attachment_url_to_postid($image), '_wp_attachment_image_alt', true); ?>"></a>
                                    ...
                                    <?php if( $slide['title'] ) : ?>
                                    <span class="supporter-name supporter-name-2"><?php echo bdevs_element_kses_basic( $slide['title'] ); ?></span>
                                    <?php endif; ?>
                              </div>
                              <?php endforeach; ?>
                        </div>
        ...
        <div class="tp-supporter__area tp-supporter__area-2 tp-supporter__area-el">
            <div class="container">
               <div class="row no-gutters">
                  <div class="col-xl-12">
        ...
        <div class="tp-supporter__area pt-55 pb-60">
            ...
            <div class="container">
                  <div class="row no-gutters">
                     <div class="col-xl-12">
                        <div class="tp-supporter__slider tp-supporter__slider-active owl-carousel text-center">
                            <?php 
                                foreach ( $settings['slides'] as $slide ) :
                                $image = wp_get_attachment_image_url( $slide['image']['id'], $settings['thumbnail_size'] );
                                if ( ! $image ) {
                            ...
                            <div class="tp-supporter__thumb">
                                <a href="<?php echo esc_url( $slide['slide_url'] ); ?>"><img src="<?php print esc_url($image); ?>" alt="<?php echo get_post_meta(attachment_url_to_postid($image), '_wp_attachment_image_alt', true); ?>"></a>
                                <?php if( $slide['title'] ) : ?>
                                <span class="supporter-name"><?php echo bdevs_element_kses_basic( $slide['title'] ); ?></span>
                                <?php endif; ?>
                            </div>
                            <?php endforeach; ?>
                        </div>
