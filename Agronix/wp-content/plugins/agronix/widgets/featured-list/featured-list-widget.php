...
class Featured_List extends BDevs_El_Widget {
    ...
    protected function render() {
        ...
        <?php if ( $settings['design_style'] === 'style_2' ): ?>
            ...
            <h6 class="services-details-title-sm"><?php echo bdevs_element_kses_intermediate($settings['title']); ?></h6>
            <?php endif; ?>

            <div class="delivery-system mb-20">
               <div class="row">
                  <?php foreach ( $settings['slides'] as $slide ): ?>
                  <div class="col-xl-6">
                     <div class="system-item d-flex mb-20">
        ...
        ?>
          ...
          <div class="tp-features-list-area">
             <div class="container">
                   ...
                   <div class="col-xl-7 col-lg-8">
                      <div class="tp-features-list">
                        ...
                        <div class="tp-list-item mb-30">
                            ...
                            <?php if( $slide['title'] ) : ?>
                            <h5 class="features-title"><?php echo bdevs_element_kses_basic( $slide['title'] ); ?></h5>
                            <?php endif; ?>
