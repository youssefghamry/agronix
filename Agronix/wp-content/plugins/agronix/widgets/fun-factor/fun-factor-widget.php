...
class Fun_Factor extends BDevs_El_Widget {
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			'_section_options',
			[
				'label' => __('Settings Options', 'bdevselement'),
				'tab'   => Controls_Manager::TAB_CONTENT
			]
		);
	...
	protected function render() {
		...
		<div class="funfact_item text-center wow fadeInUp22" data-wow-delay=".1s">
            <div class="content_wrap">
                ...
                <?php printf( '<%1$s %3$s>%2$s</%1$s>',
                    ...
                    bdevs_element_kses_basic( $settings['fun_factor_title'] ),
