...
class Icon_Box extends BDevs_El_Widget {
    ...
    protected function register_content_controls() {
        ...
        $this->add_control(
            'icon_link',
            [
                'label' => __( 'Icon Link', 'bdevselement' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => 01,
                'description' => __( 'Type number', 'bdevselement' ),
                'condition' => [
    ...
    protected function render() {
        ...
        <?php elseif ( $settings['design_style'] === 'style_3' ): ?>
            ...
            <div class="project-img project-img-d mb-70">
               ...
               <div class="project-img-content project-img-content-d">
                   <?php if ( $settings['title'] ) : ?>
                   <h4 class="project-sm-title project-title-d bdevs-el-title"><?php echo esc_html( $settings['title'] ); ?></h4>
                   <?php endif; ?>

                    <?php if ( $settings['description'] ) : ?>
                    <p class="bdevs-el-description"><?php echo esc_html( $settings['description'] ); ?></p>
                    <?php endif; ?>
        ...
        <?php elseif ( $settings['design_style'] === 'style_2' ): ?>
            ...
            <div class="single-box mb-30">
               ...
               <?php if ( $settings['title'] ) : ?>
               <h6 class="icon-box-title bdevs-el-title"><?php echo esc_html( $settings['title'] ); ?></h6>
               <?php endif; ?>
            </div>

        <?php else: 
            $this->add_inline_editing_attributes( 'title', 'basic' );
            $this->add_render_attribute( 'title', 'class', 'services__title bdevs-el-title' );
        ?>

         <div class="sd-services-item mb-30">
            <?php if ( $settings['type'] === 'image' && ( $settings['image']['url'] || $settings['image']['id'] ) ) :
                $this->get_render_attribute_string( 'image' );
                $settings['hover_animation'] = 'disable-animation'; // hack to prevent image hover animation
                ?>
            ...
            <?php endif; ?>
            <div class="sd-services-content">
                <?php if ( $settings['title'] ) : ?>
                <h6 class="sd-services-title bdevs-el-title"><?php echo esc_html( $settings['title'] ); ?></h6>
                <?php endif; ?>
