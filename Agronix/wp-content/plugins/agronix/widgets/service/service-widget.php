...
class Service extends BDevs_El_Widget {
    ...
    protected function register_content_controls() {
        ...
        $repeater->add_control( 
            'svg_icon',
            [
                'label' => __( 'SVG Icon', 'bdevselement' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
    ...
    protected function render() {
        ...
        <section class="contact__area grey-bg-2 pt-120 pb-90 p-relative fix">
            ...
            <div class="contact__shape">
               <img class="contact-shape-5" src="<?php print get_template_directory_uri(); ?>/assets/img/contact/contact-shape-5.png" alt="img">
               <img class="contact-shape-4" src="<?php print get_template_directory_uri(); ?>/assets/img/contact/contact-shape-4.png" alt="img">
            </div>
            <?php endif;?>
               ...
               <div class="row justify-content-center">
                    ...
                    <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-6">
                        <div class="contact__item text-center mb-30 transition-3 white-bg">
                            ...
                            <?php elseif( !empty($slide['icon']) || !empty($slide['selected_icon']) ): ?>
                            <div class="contact__icon d-flex justify-content-center align-items-end 1">
                            <?php bdevs_element_render_icon( $slide, 'icon', 'selected_icon', ['class' => 'bdevs-btn-icon'] ); ?>
                            </div>
                            <?php else: ?> 
                            <div class="contact__icon d-flex justify-content-center align-items-end 2">
                            ...
                            <div class="contact__content bdevs-el-content">
                                <?php if( $slide['title'] ) : ?>
                                    <h3 class="contact__title bdevs-el-title"><?php echo bdevs_element_kses_basic( $slide['title'] ); ?></h3>
                                <?php endif; ?>
                                ...
                                <?php if ( $slide['button_text'] ): ?>
                                    <a href="<?php echo esc_url( $slide['s_url'] ); ?>" class="e-btn e-btn-border"><?php echo bdevs_element_kses_intermediate( $slide['button_text'] ); ?></a>
                                <?php endif; ?>
