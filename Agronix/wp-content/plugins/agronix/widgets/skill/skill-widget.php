...
class Skill extends BDevs_El_Widget {
	...
	protected function render() {
        ...
        <div class="team-member-info">
            <div class="container">
               <div class="member-skill pt-100 pb-45">
                  <div class="row align-items-center">
                     ...
                     <div class="col-xl-6 col-lg-6">
                        <div class="member-bio">
                           ...
                           <h5 class="skill-title"><?php echo bdevs_element_kses_intermediate( $settings['title'] ); ?></h5>
                           <?php endif; ?>

                           <?php foreach ( $settings['slides'] as $slide ) :?>
                           <div class="skill-activity mt-40 mb-35">
                              <div class="skill-sub-title">
                                  <h5 class="skill-sub-title-left"><?php echo bdevs_element_kses_basic( $slide['title'] ); ?></h5>
                                  <h5><span class="counter"><?php echo esc_html( $slide['number'] ); ?></span><span>%</span></h5>
                              </div>
                              <div class="progress progress-line">     
                                 <div class="bar progress-bar progress-bar-td" data-width="<?php echo esc_html( $slide['number'] ); ?>" role="progressbar" style="min-width:<?php echo esc_html( $slide['number'] ); ?>%"></div>
                              </div>                                       
                           </div>
                           <?php endforeach; ?>
                        </div>
