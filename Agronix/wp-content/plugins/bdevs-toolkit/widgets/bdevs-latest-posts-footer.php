...
Class Latest_posts_footer_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct( 'bdevs-latest-posts-footer', 'Wetland Footer Posts Image', [
            'description' => 'Wetland Post Widget by Fastpro',
        ] );
    }
            ...
            while ( $q->have_posts() ): $q->the_post();
				...
				<?php endif; ?>
					<div class="content">
						...
						<span class="date"><i class="fal fa-calendar-alt"></i> <span><?php the_time( 'F d, Y' );?></span></span>
					</div>
				</div>
