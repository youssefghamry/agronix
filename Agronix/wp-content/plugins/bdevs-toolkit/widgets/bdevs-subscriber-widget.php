<?php
    ...
    class Bdevs_Subscriber_Widget  extends WP_Widget{
        ...
        public function __construct(){
            parent::__construct('bdevs_subscriber_widget',esc_html__('Agronix Subscriber','bdevs-toolkit'),array(
                'description' => esc_html__('Agronix Subscriber Widget','bdevs-toolkit'),
            ));
        }
